...
/**action */
restService.post('/detailsMovie', (req, res) => {
    console.log(req.body.result);
    const movieToSearch = req.body.result && req.body.result.parameters && req.body.result.parameters.movie ? req.body.result.parameters.movie : 'DeadPool';
